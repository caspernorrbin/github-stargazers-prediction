...
instance_prod = nova.servers.create(name="Group6_prod_server"+str(identifier), image=image, flavor=flavor, key_name='Group6_key',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="Group6_dev_server"+str(identifier), image=image, flavor=flavor, key_name='Group6_key',userdata=userdata_dev, nics=nics,security_groups=secgroups)
